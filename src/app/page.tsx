  ...
  return (
    <main className="min-h-screen bg-red-500 text-white">
      ...
      <Services
        ...
        services={[
          {
            name: "Diseño web optimizado para SEO",
            icon: "seo",
            description: "Diseñamos su sitio web para atraer más tráfico.",
          },
          {
            name: "Integración de Inteligencia Artificial",
            icon: "ai",
            description: "Hacemos que su sitio web sea más inteligente.",
          },
          {
            name: "Optimización de ventas",
            icon: "sales",
            description: "Transformamos su sitio web en una máquina de ventas.",
          },
          {
            name: "Actualización de sitios web antiguos",
            icon: "update",
            description: "Damos nueva vida a su sitio web existente.",
          },
          {
            name: "Creación de sitios web gratuitos",
            icon: "free",
            description:
              "Ayudamos a los emprendedores a lanzar su negocio online.",
          },
        ]}
      />
      <BeforeAndAfter />
      ...
      <Faq
        faqs={[
          {
            pregunta:
              "¿Por qué necesito una página web si ya tengo presencia en las redes sociales?",
            respuesta:
              "Las redes sociales son una excelente herramienta de marketing, pero no reemplazan a un sitio web profesional. Tu sitio web es el núcleo de tu presencia online, donde tienes control total y puedes presentar tu [companyName] de la manera que desees. Además, un sitio web bien diseñado y optimizado puede ayudarte a atraer más tráfico de motores de búsqueda como Google.",
          },
          {
            pregunta:
              "Tengo una página web antigua, ¿realmente necesito actualizarla?",
            respuesta:
              "Sí, definitivamente. Un sitio web desactualizado puede dar la impresión de que tu [companyName] no está a la altura de la competencia. Además, las tecnologías web han avanzado mucho en los últimos años, y un sitio antiguo puede no ser compatible con los nuevos estándares, lo que dificulta su visualización y uso en dispositivos modernos.",
          },
          {
            pregunta:
              "¿Es realmente necesario gastar dinero en un diseño web profesional?",
            respuesta:
              "Un diseño web profesional no es solo una cuestión de estética. Un buen diseño facilita la navegación de tus visitantes, mejora la experiencia de usuario y ayuda a convertir a esos visitantes en clientes. Además, un diseño web de calidad puede ayudarte a mejorar tu clasificación en los motores de búsqueda y atraer más tráfico a tu sitio.",
          },
          {
            pregunta:
              "¿Por qué debería invertir en tecnología y optimización de sistemas?",
            respuesta:
              "La tecnología y la optimización de sistemas pueden ayudarte a mejorar la eficiencia de tu sitio web, haciendo que las páginas se carguen más rápido y sean más fáciles de usar. Esto puede mejorar la experiencia de usuario, lo que a su vez puede aumentar las tasas de conversión y ayudarte a generar más ventas. Además, los motores de búsqueda premian a los sitios que ofrecen una buena experiencia de usuario con rankings más altos.",
          },
          {
            pregunta:
              "¿Cómo puede la inteligencia artificial (IA) ayudar a mi negocio en línea?",
            respuesta:
              "La IA puede ayudarte a automatizar tareas, analizar grandes cantidades de datos y personalizar la experiencia de tus clientes. Por ejemplo, puedes usar la IA para automatizar el servicio al cliente, analizar el comportamiento de los visitantes y ofrecer recomendaciones personalizadas de productos. Esto puede ayudarte a ahorrar tiempo, mejorar la eficiencia y aumentar las ventas.",
          },
        ]}
      />
